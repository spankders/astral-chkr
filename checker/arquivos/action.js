    ...
    $.ajax({
        ...
        success: function (data) {
            ...
            if (data.d.Result.includes("problems")) {
                ...
                $("#reprovadas").append("<span class='label label-danger'>#Reprovada ❌ </span> " + url + " #marcoROOT<br/>");
                ...
                remover_linha("#lista");
                document.getElementById("testado").innerHTML = (eval(document.getElementById("testado").innerHTML) + 1);
                $("#aprovadas").append('<span class="label label-success">#Aprovada ✅</span> ' + url + ' #marcoROOT <br/>');
